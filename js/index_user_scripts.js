 ...
 */
 ...
 //$(document).on('pagebeforeshow','#mainpage', function(event) {register_event_handlers();});
 //$(document).on('pagebeforeshow','#Ticket', function(event) {register_event_handlers();});
 document.addEventListener("DOMContentLoaded", function(event) {register_event_handlers(); });
